<nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Manage Fund <span class="caret"></span></a>
          <ul class="dropdown-menu">
            ...
            <li><a href="visitor_research_fund.do">Research Fund</a></li>
          </ul>
        </li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="visitor_view_account.do"><span class="glyphicon glyphicon-user"></span> ${visitor.firstName} ${visitor.lastName}</a></li>
