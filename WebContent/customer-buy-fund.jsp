  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="col-sm-10">
        ...
        <div>
          <ul class="breadcrumb">
            <li><a href="visitor_view_account.do"> <span class="glyphicons glyphicons-home"></span></i>Home</a></li>
                  ...
                  <tbody>
                    <c:forEach var="fund" items="${customerFundBeans}">
                      <tr>
                        ...
                        <td>${fund.symbol}</td>
                        <td>${fund.price} </td>
                        <td><button onclick="document.getElementById('fund-name').value = '${fund.name}';">Buy</button></td>
                      </tr>
                   </c:forEach>
                  </tbody>
                </table>
