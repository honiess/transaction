        ...
        <div class="row">
                  ...
                  <tbody>
                    <c:forEach var="fund" items="${customerFundBeans}">
                      <tr>
                        ...
                        <td><button onclick="document.getElementById('fund-name').value = '${fund.name}';">Sell</button></td>
                      </tr>
                   </c:forEach>
                  </tbody>
                </table>
          ...
          <div class="col-sm-4">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <form class="form-inline" role="form" method="post" action="visitor_sell_fund.do">
